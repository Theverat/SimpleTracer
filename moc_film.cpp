...
**
** Created: Sun May 20 19:07:07 2012
...
static const char qt_meta_stringdata_Film[] = {
    "Film\0\0addSamples(QVector<QVector<renderPixel> >)\0"
};
...
void Film::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Film *_t = static_cast<Film *>(_o);
        switch (_id) {
        case 0: _t->addSamples((*reinterpret_cast< QVector<QVector<renderPixel> >(*)>(_a[1]))); break;
        default: ;
        }
    }
}

const QMetaObjectExtraData Film::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject Film::staticMetaObject = {
    { &QThread::staticMetaObject, qt_meta_stringdata_Film,
      qt_meta_data_Film, &staticMetaObjectExtraData }
};
